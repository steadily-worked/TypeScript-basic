import { CovidSummaryResponse } from './covid/api';
...
function getUnixTimestamp(date: string) {
  ...
  // 이미 자바스크립트 내장 함수라면, 타입이 알아서 추론이 된다.
}

// DOM
const confirmedTotal = $('.confirmed-total') as HTMLSpanElement;
const deathsTotal = $('.deaths') as HTMLParagraphElement;
// 일반 element에서는 호환되지 않는 타입이었기 때문에 (innerText)
...
function fetchCountryInfo(countryCode: string, status: CovidStatus) {
  ...
  // ex: https://api.covid19api.com/live/country/south-africa/status/confirmed
  // https://documenter.getpostman.com/view/10808728/SzS8rjbc?version=latest#63fda84a-6b43-4506-9cc7-2172561d5c16 참고
